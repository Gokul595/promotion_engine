class Promotion < ApplicationRecord
  ...
  enum :promo_type, { percentage: 0, fixed_amount: 1, weight_threshold: 2, buy_x_get_y: 3 }, prefix: :promo
  enum :discount_type, { percentage: 0, fixed_amount: 1 }, prefix: :discount
